        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              ...
              isOpen ? "bg-accent/10 border-accent/20 text-accent" : "bg-white/[0.04] border-white/[0.08] text-muted-foreground"
            )}
          >
    ...
    <section className="relative py-24 md:py-32 overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[900px] px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          description="Everything you need to know about working with SmartByte."
          align="center"
          className="mb-12"
        />
