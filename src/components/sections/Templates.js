          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {templates.map((template, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group relative overflow-hidden rounded-2xl border border-white/5 bg-card"
              >
                <div
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <div className="flex items-center gap-3">
                        <span className="flex items-center gap-1 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm text-white text-sm">
