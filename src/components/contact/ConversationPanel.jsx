...
function ContactMethod({ icon: Icon, title, value, index }) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 backdrop-blur-xl transition-all duration-500 hover:border-accent/20 hover:shadow-[0_0_30px_rgba(0,194,168,0.06)]"
    >
  ...
  return (
    <div className="space-y-6 lg:sticky lg:top-32 lg:self-start">
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl border border-white/[0.06] bg-white/[0.03] p-6 backdrop-blur-xl sm:p-8"
      >
        <div
          className="pointer-events-none absolute -right-20 -top-20 h-40 w-40 rounded-full opacity-10"
          style={{
            background:
              "radial-gradient(circle, rgba(0, 194, 168, 0.2), transparent 70%)",
            filter: "blur(40px)",
          }}
        />
