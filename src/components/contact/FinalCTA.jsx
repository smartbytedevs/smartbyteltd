  ...
  return (
    <section className="relative mt-[120px] overflow-hidden py-[100px] sm:mt-[140px] sm:py-[120px] lg:py-[150px]">
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 50% at 50% 50%, rgba(15, 118, 110, 0.08) 0%, rgba(14, 116, 144, 0.04) 40%, transparent 70%)",
          filter: "blur(120px)",
        }}
      />
      <div
        ...
        style={{
          ...
          height: "800px",
          background:
            "radial-gradient(circle, rgba(14, 116, 144, 0.03), transparent 70%)",
          filter: "blur(100px)",
        }}
      />
