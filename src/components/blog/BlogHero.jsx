          ...
          <div className="max-w-4xl">
            ...
            <SafeSlideUp delay={0.4}>
              <p className="mt-6 text-base sm:text-lg text-muted max-w-2xl leading-relaxed">
                Discover practical guides, industry insights, web development tips, UI/UX inspiration, SEO strategies, AI workflows, and digital transformation advice from the SmartByte team.
              </p>
            </SafeSlideUp>
            ...
            <SafeSlideUp delay={0.5}>
              <div className="mt-10 flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium rounded-full border border-border/40 text-foreground hover:bg-accent/[0.12] hover:border-accent/30 transition-all duration-300"
                >
                  Start Your Project
                </button>
              </div>
