    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0, 194, 168, 0.07), transparent 70%)",
            filter: "blur(120px)",
          }}
        />
        <div
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0, 194, 168, 0.04), transparent 70%)",
            filter: "blur(120px)",
          }}
        />
            ...
            <div className="w-full py-16 lg:py-0 lg:pr-8">
              ...
              <div className="relative">
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(0, 194, 168, 0.1), transparent 70%)",
                    filter: "blur(80px)",
                  }}
                />
