      ...
      <div className="relative aspect-[4/3] overflow-hidden rounded-3xl bg-neutral-900">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-5">
          ...
          <div>
            ...
            {article.catLabels.length > 0 && (
              <div className="flex flex-wrap gap-1.5">
                {article.catLabels.map((label) => (
                  <span
                    key={label}
...
export function BlogArticleView({ article, author, catLabels, dateLabel, related }) {
              ...
              <div className="sticky top-28 space-y-8 lg:col-span-4">
                ...
                {related.length > 0 ? (
                  related.map((relatedArticle) => (
                    <RelatedCard key={relatedArticle.slug} article={relatedArticle} />
                  ))
                ) : (
