      ...
      <Link href={`/blog/${article.slug}`} className="group block">
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-6">
            ...
            {/* Bottom */}
            <div>
              <h3 className="mb-3 text-2xl font-bold text-white transition-colors group-hover:text-[#8ba4ff]">
                {article.title}
              </h3>
    ...
    <Link href={`/blog/${article.slug}`} className="group block">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h2 className="mb-4 max-w-2xl text-3xl font-extrabold tracking-tight text-white transition-colors group-hover:text-[#8ba4ff] md:text-5xl">
            {article.title}
          </h2>
          <span className="mb-4 flex items-center gap-2 text-sm text-white/90">
            Read article{" "}
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
              ...
              <div className="lg:col-span-7">
                ...
                >
                  <span className="inline-flex w-fit shrink-0 items-center rounded-full bg-[#8ba4ff] px-5 py-2 text-sm font-semibold text-black">
              ...
              <div className="relative lg:col-span-5">
                <motion.div
                  ...
                  className="absolute -top-4 left-6 z-10 rounded-full bg-[#8ba4ff] px-5 py-2 text-sm font-semibold text-black shadow-md"
                >
                  Senior specialists
                </motion.div>
